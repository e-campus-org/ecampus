...
const codeErrorMessages = ref<string[]>([]);
...
watch(
    ...
    newVal => {
        ...
        if (newVal && props.item) {
            ...
            editedItem.shortTitle = props.item.shortTitle;
            ...
            editedItem.requiredTexts = props.item.requiredTexts;
...
function validateInputs() {
    ...
    if (!editedItem.code) {
        codeErrorMessages.value.push(props.err.code || "Code is required.");
        isValid = false;
    }
